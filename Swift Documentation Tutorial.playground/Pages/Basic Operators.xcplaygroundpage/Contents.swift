...
let plusTwo = -two // 2
// Unary Plus Operator does nothing besides providing code symmetry for positive numbers
...
/*
 ...
 |  a should be an optional and b should not be an optional while matching the type of a
